...
;;; B152/B153: dotted-tail, vector, and ellipsis-before-dotted patterns (Chez/Chibi cross-impl probe).
;;; These were LL divergences from Chez/Chibi; now all pass.
(define-syntax b152-cnt (syntax-rules () ((_ ()) 0) ((_ (h . t)) (+ 1 (b152-cnt t)))))
(check "dotted recursive"    3          (b152-cnt (a b c)))        ; B152: (h . t) vs one-element list
(define-syntax b153-vecpat (syntax-rules () ((_ #(a b c)) (+ a b c))))
(check "vector pattern"      15         (b153-vecpat #(4 5 6)))    ; B153: vector pattern
(define-syntax b153-vecell (syntax-rules () ((_ #(a ...)) (list a ...))))
(check "vector pattern ell"  '(1 2 3)   (b153-vecell #(1 2 3)))    ; B153: ellipsis in vector pattern
(define-syntax b153-vectmpl (syntax-rules () ((_ a b) #(a b))))
(check "vector template"     '#(1 2)    (b153-vectmpl 1 2))        ; B153: vector template
(define-syntax b153-vecswap (syntax-rules () ((_ #(a b)) #(b a))))
(check "vector pat+tmpl"     '#(2 1)    (b153-vecswap #(1 2)))     ; B153: vector both sides
(define-syntax b153-vectmpl-ell (syntax-rules () ((_ x ...) #(0 x ...))))
(check "vector template ell" '#(0 1 2 3) (b153-vectmpl-ell 1 2 3)) ; B153: ellipsis in vector template
(define-syntax b153-elldot (syntax-rules () ((_ (a ... . r)) (list (list a ...) r))))
(check "ellipsis-dotted"     '((1 2 3) 4) (b153-elldot (1 2 3 . 4)))       ; B153: (a ... . r)
(define-syntax b153-elldotmid (syntax-rules () ((_ (a b ... . r)) (list (list b ...) r))))
(check "ellipsis-dotted mid"  '((2 3) 4) (b153-elldotmid (1 2 3 . 4)))     ; B153: (a b ... . r)
